...
socket.on("user disconnected", function(data){
  addNewMessage({user: data, message: `${data} has disconnected`}) 
})

socket.on("new user", function (data) {
  addNewMessage({user: data, message: `${data} has connected`}) 
});

socket.on("user is typing", function(data){
  addNewMessage({user: "SYSTEM", message: `${data} is typing.....`})
})